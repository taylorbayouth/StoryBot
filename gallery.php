...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      ...
      <p class="lead text-muted">There's something here for everyone from futuristic space missions to plot-twisting bank heists to murder mysteries.</p>
      <p>
        <a href="#" class="btn btn-primary my-2">Creator Tools</a>
        <a href="#" class="btn btn-secondary my-2">Previously Viewed</a>
      </p>
    </div>
  </section>
